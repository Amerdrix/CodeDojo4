...
describe 'load a user from json' do
  ...
  context "with a user" do
    ...
    it "user has name" do
      expect(user.gender).to_not be_nill
      expect(user.gender).to be_equal("male")
    end
  end
end
...
describe 'load a user form the api' do
  ...
  context "with a cached user" do
    ...
    it "has all the user parameters" do
      ...
      expect(user.version).to_not be_nil
    end
  end
end
